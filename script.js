...
function generatePassword(){
    ...
    let characters = "azertyuipqsdfghjklmwxcvbn" // Order du clavier et non alphabétique. Ils sont maintenant inclue dans la variable que l'on à créer : let characters.

    // Création d'une condition pour s'avoir si le bouton est ou non cocher.
    if(document.getElementById("include-majuscule").checked){
        characters += "AZERTYUIPQSDFGHJKLMWXCVBN";
